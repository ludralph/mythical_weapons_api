...
var BookStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("could not get books ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("could not find book with id ".concat(id, ", ").concat(error_2, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    BookStore.prototype.create = function (b) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, book, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [b.title, b.author, b.totalPages, b.type, b.summary])];
                    case 2:
                        result = _a.sent();
                        book = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("could not add new book ".concat(b.title, ", ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Could not delete book with id, Error ".concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    BookStore.prototype.update = function (id, title, author) {
        return __awaiter(this, void 0, void 0, function () {
