        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("could not find user with id ".concat(id, ", ").concat(error_2, " "));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1["default"].hashSync(user.password + pepper, parseInt("10"));
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("unable to create user ".concat(user.username, ":  ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
